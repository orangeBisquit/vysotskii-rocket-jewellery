...
(function (global, factory) {
  ...
  function EventBus() {
    ...
    function off(events, key) {
      forEachEvent(events, (event, namespace) => {
        ...
        handlers[event] = eventHandlers && eventHandlers.filter((handler) => handler._key ? handler._key !== key : key || handler._namespace !== namespace);
      });
    }
    ...
    function onPointerMove(e) {
      ...
      if (e.cancelable) {
        ...
        if (dragging) {
          ...
          let thresholds = options.dragMinThreshold;
  ...
  function Keyboard(Splide2, Components2, options) {
    ...
    function init() {
      const _options$keyboard = options.keyboard,
  ...
  function LazyLoad(Splide2, Components2, options) {
    const _EventInterface14 = EventInterface(Splide2),
  ...
  function Pagination(Splide2, Components2, options) {
    const _EventInterface15 = EventInterface(Splide2),
  ...
  function Sync(Splide2, Components2, options) {
    ...
    function sync() {
      ...
      splides.concat(Splide2).forEach((splide, index, instances) => {
        const _EventInterface16 = EventInterface(splide),
    ...
    function navigate() {
      const _EventInterface17 = EventInterface(Splide2),
  ...
  function Wheel(Splide2, Components2, options) {
    const _EventInterface18 = EventInterface(Splide2),
  ...
  function Fade(Splide2, Components2, options) {
    const _EventInterface19 = EventInterface(Splide2),
  ...
  function Slide(Splide2, Components2, options) {
    const _EventInterface20 = EventInterface(Splide2),
  ...
  const _Splide = /*#__PURE__*/function () {
    ...
    _proto.mount = function mount(Extensions, Transition) {
      ...
      forOwn(Constructors, (Component, key) => {
        const component = Component(_this3, Components2, _this3._options);
