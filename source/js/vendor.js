    ...
    for (let a = 1; a < e.length; a += 1) {
        ...
        if (null != i && !isNode(i)) {
            ...
            for (let s = 0, a = e.length; s < a; s += 1) {
                ...
                void 0 !== r &&
                    r.enumerable &&
                    (isObject(t[a]) && isObject(i[a]) ? (i[a].__swiper__ ? (t[a] = i[a]) : extend(t[a], i[a])) : !isObject(t[a]) && isObject(i[a]) ? ((t[a] = {}), i[a].__swiper__ ? (t[a] = i[a]) : extend(t[a], i[a])) : (t[a] = i[a]));
            }
        }
    }
    return t;
...
function calcDevice({ userAgent: e } = {}) {
    ...
    return (
        !d &&
            h &&
            t.touch &&
            ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${n}x${l}`) >= 0 &&
            ...
            c[i] && (c[i].swiperSlideSize = T),
                ...
                a.centeredSlides
                    ? ((x = x + T / 2 + y / 2 + b),
                      ...
                      h.push(x))
                    : (a.roundLengths && (x = Math.floor(x)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && u.push(x), h.push(x), (x = x + T + b)),
                (e.virtualSize += T + b),
                (y = T),
                (E += 1);
        }
...
function Keyboard({ swiper: e, extendParams: t, on: s, emit: a }) {
    ...
    function n(t) {
        ...
        if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || (i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase())))) {
            ...
            e.isHorizontal()
                ? ((d || c || p || u) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)), (((c || u) && !s) || ((d || p) && s)) && e.slideNext(), (((d || p) && !s) || ((c || u) && s)) && e.slidePrev())
                : ((d || c || h || m) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)), (c || m) && e.slideNext(), (d || h) && e.slidePrev()),
                a("keyPress", l);
        }
    }
    function l() {
...
function Pagination({ swiper: e, extendParams: t, on: s, emit: a }) {
    ...
    function d() {
        ...
        if (
            ...
            if (
                (s.dynamicBullets &&
                    ...
                    s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((n += c - e.previousIndex), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)),
                    (i = c - n),
        ...
        "custom" === s.type && s.renderCustom ? (d.html(s.renderCustom(e, c + 1, p)), a("paginationRender", d[0])) : a("paginationUpdate", d[0]),
...
function Scrollbar({ swiper: e, extendParams: t, on: s, emit: a }) {
    ...
    function g(t) {
        const s = e.params.scrollbar,
            ...
            { $el: l, $dragEl: o } = i;
        (d = !0),
            (r = t.target === o[0] || t.target === o ? m(t) - t.target.getBoundingClientRect()[e.isHorizontal() ? "left" : "top"] : null),
            t.preventDefault(),
            t.stopPropagation(),
            n.transition(100),
            o.transition(100),
...
function Zoom({ swiper: e, extendParams: t, on: s, emit: a }) {
    ...
    function f(t) {
        ...
        (c.$imageEl = c.$slideEl.find(`.${a.containerClass}`).eq(0).find("img, svg, canvas, picture, .swiper-zoom-target")),
    ...
    function v(t) {
        ...
        c.$imageEl &&
            0 !== c.$imageEl.length &&
            ((r.scale = Math.max(Math.min(r.scale, c.maxRatio), i.minRatio)), c.$imageEl.transition(e.params.speed).transform(`translate3d(0,0,0) scale(${r.scale})`), (o = r.scale), (d = !1), 1 === r.scale && (c.$slideEl = void 0));
    }
    function w(t) {
        const s = e.zoom;
    ...
    function x(t) {
        ...
        if (
            (c.$slideEl ||
                ...
                c.$slideEl || (e.params.virtual && e.params.virtual.enabled && e.virtual ? (c.$slideEl = e.$wrapperEl.children(`.${e.params.slideActiveClass}`)) : (c.$slideEl = e.slides.eq(e.activeIndex))),
                (c.$imageEl = c.$slideEl.find(`.${a.containerClass}`).eq(0).find("img, svg, canvas, picture, .swiper-zoom-target")),
                (c.$imageWrapEl = c.$imageEl.parent(`.${a.containerClass}`))),
        ...
        e.params.cssMode && ((e.wrapperEl.style.overflow = "hidden"), (e.wrapperEl.style.touchAction = "none")),
            ...
            void 0 === p.touchesStart.x && t ? ((r = "touchend" === t.type ? t.changedTouches[0].pageX : t.pageX), (n = "touchend" === t.type ? t.changedTouches[0].pageY : t.pageY)) : ((r = p.touchesStart.x), (n = p.touchesStart.y)),
    ...
    function y() {
        const t = e.zoom,
            s = e.params.zoom;
        c.$slideEl ||
            (e.params.virtual && e.params.virtual.enabled && e.virtual ? (c.$slideEl = e.$wrapperEl.children(`.${e.params.slideActiveClass}`)) : (c.$slideEl = e.slides.eq(e.activeIndex)),
            (c.$imageEl = c.$slideEl.find(`.${s.containerClass}`).eq(0).find("img, svg, canvas, picture, .swiper-zoom-target")),
    ...
    function k() {
        ...
        s.gestures
            ...
            : "touchstart" === e.touchEvents.start &&
              (e.$wrapperEl.on(e.touchEvents.start, r, f, a), e.$wrapperEl.on(e.touchEvents.move, r, g, i), e.$wrapperEl.on(e.touchEvents.end, r, v, a), e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, r, v, a)),
    ...
    function z() {
        ...
        s.gestures
            ...
            : "touchstart" === e.touchEvents.start &&
              (e.$wrapperEl.off(e.touchEvents.start, r, f, a), e.$wrapperEl.off(e.touchEvents.move, r, g, i), e.$wrapperEl.off(e.touchEvents.end, r, v, a), e.touchEvents.cancel && e.$wrapperEl.off(e.touchEvents.cancel, r, v, a)),
            ...
            e.params.a11y.enabled &&
                (function () {
                    ...
                    a && a.length > 0 && a.remove(),
                        ...
                        t && t.off("keydown", u),
                        s && s.off("keydown", u),
                        m() && e.pagination.$el.off("keydown", classesToSelector(e.params.pagination.bulletClass), u);
                })();
        });
}
                ...
                onTouchEnd: function ({ currentPos: t }) {
                    ...
                    if (t < -e.minTranslate()) e.slideTo(e.activeIndex);
                        ...
                        if (i.freeMode.momentum) {
                            ...
                            let m;
                            if (c < e.maxTranslate())
                                i.freeMode.momentumBounce ? (c + e.maxTranslate() < -h && (c = e.maxTranslate() - h), (p = e.maxTranslate()), (u = !0), (o.allowMomentumBounce = !0)) : (c = e.maxTranslate()),
                                    i.loop && i.centeredSlides && (m = !0);
                            else if (c > e.minTranslate())
                                i.freeMode.momentumBounce ? (c - e.minTranslate() > h && (c = e.minTranslate() + h), (p = e.minTranslate()), (u = !0), (o.allowMomentumBounce = !0)) : (c = e.minTranslate()),
                                    i.loop && i.centeredSlides && (m = !0);
...
function EffectCube({ swiper: e, extendParams: t, on: s }) {
    ...
    effectInit({
        ...
        setTranslate: () => {
            ...
            d.shadow &&
                (c
                    ? ((u = s.find(".swiper-cube-shadow")), 0 === u.length && ((u = $('<div class="swiper-cube-shadow"></div>')), s.append(u)), u.css({ height: `${i}px` }))
            ...
            for (let e = 0; e < a.length; e += 1) {
                ...
                let u = 0,
                    m = 0,
                    f = 0;
                s % 4 == 0 ? ((u = 4 * -r * l), (f = 0)) : (s - 1) % 4 == 0 ? ((u = 0), (f = 4 * -r * l)) : (s - 2) % 4 == 0 ? ((u = l + 4 * r * l), (f = l)) : (s - 3) % 4 == 0 && ((u = -l), (f = 3 * l + 4 * l * r)),
                    n && (u = -u),
                    c || ((m = u), (u = 0));
                ...
                if ((o <= 1 && o > -1 && ((h = 90 * s + 90 * o), n && (h = 90 * -s - 90 * o)), t.transform(g), d.slideShadows)) {
                    ...
                    0 === e.length && ((e = $(`<div class="swiper-slide-shadow-${c ? "left" : "top"}"></div>`)), t.append(e)),
                        0 === s.length && ((s = $(`<div class="swiper-slide-shadow-${c ? "right" : "bottom"}"></div>`)), t.append(s)),
